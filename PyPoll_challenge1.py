...
file_to_load = os.path.join(r"C:\Users\bajaj\UOT\Assignments\python\election_result.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join(r"C:\Users\bajaj\UOT\Assignments\python\election_result.txt")
